...
wire [2:0] sel = 
(RegAddr == M_RegWriteAddr && M_RegWriteAddr!=0 && M_RegWrite && M_Tnew==0)? 2'b10:
//(RegAddr == M_RegWriteAddrSpecial && M_RegWriteAddrSpecial!=0 && M_RegWrite && M_Tnew==0 && new==1)? 2'b10:
